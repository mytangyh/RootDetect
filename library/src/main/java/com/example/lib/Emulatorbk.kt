...
class Emulatorbk {
    ...
    private val ldAppName = arrayOf(
        "/sdcard/ldAppStore",
        "/system/priv-app/ldAppStore/ldAppStore.apk",
    ...
    private val buildInfo: String
        private get() {
            ...
            result = if (Build.FINGERPRINT.lowercase(Locale.getDefault())
                    .contains("test-keys") || Build.FINGERPRINT.lowercase(Locale.getDefault())
                    .contains("dev-keys")
            ) {
                result + "1"
            } else {
    ...
    private val vBoxFile = arrayOf(
        ...
        "/mnt/prebundledapps/propfiles/ics" +
                ".bluestacks" + ".prop.note",
        ...
        "/sys" +
                "/devices/virtual/misc/vboxguest" + "/subsystem",
        "/sys/devices/virtual/misc" +
                "/vboxguest" + "/uevent",
        "/sys/devices" + "/virtual/misc/vboxuser",
        "/sys/devices" +
                "/virtual/misc/vboxuser" + "/dev",
        ...
        "/sys" +
                "/module/vboxguest/sections/.data",
        "/sys/module/vboxguest/sections/" + ".devinit" +
                ".data",
        ...
        "/sys" +
                "/module/vboxguest/sections/__param",
        "/sys/module" + "/vboxguest/srcversion",
        "/sys" +
                "/module/vboxguest/taint",
        ...
        "/sys/module" +
                "/vboxsf" + "/sections/.exit.text",
        "/sys/module/vboxsf/sections/" + ".gnu.linkonce" +
                ".this_module",
        ...
        "/sys" +
                "/module/vboxsf/sections/" + ".rodata.str1.1",
        "/sys/module/vboxsf/sections/" +
                ".smp_locks",
        ...
        "/sys/module" +
                "/vboxvideo/sections/.data",
        "/sys/module/vboxvideo" + "/sections/.exit.text",
        "/sys" +
                "/module/vboxvideo/sections/.gnu" + ".linkonce" + ".this_module",
        "/sys/module" +
                "/vboxvideo/sections/.init.text",
        "/sys/module" + "/vboxvideo/sections/.note.gnu" +
                ".build-id",
        "/sys/module/vboxvideo/sections/.rodata" + ".str1.1",
        "/sys/module" +
                "/vboxvideo/sections/.strtab",
    ...
    companion object {
        private var emulator: Emulatorbk? = null
        val instance: Emulatorbk?
            get() {
                if (emulator == null) {
                    emulator = Emulatorbk()
                }
